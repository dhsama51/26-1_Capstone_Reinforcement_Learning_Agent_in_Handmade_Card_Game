...
{
    public void ResetAndInit(string player1Deck, string player2Deck, ILogger logger)
    {
        Logger = logger;
        Data = new GameData(_player1Id, _player2Id, Logger);
        _actions = [];
        Init(player1Deck, player2Deck);
    }
